...
/** @param {Array.<!proto.google.api.HttpRule>|undefined} value  */
...
proto.google.api.HttpRule.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    selector: jspb.Message.getField(msg, 1),
...
proto.google.api.HttpRule.prototype.clearSelector = function() {
...
proto.google.api.HttpRule.prototype.clearBody = function() {
...
proto.google.api.CustomHttpPattern.prototype.clearKind = function() {
  jspb.Message.setField(this, 1, undefined);
};
...
proto.google.api.CustomHttpPattern.prototype.clearPath = function() {
