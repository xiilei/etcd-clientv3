...
proto.etcdserverpb.RangeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: msg.getKey(),
    rangeEnd: msg.getRangeEnd(),
    limit: msg.getLimit(),
    revision: msg.getRevision(),
    sortOrder: msg.getSortOrder(),
    sortTarget: msg.getSortTarget(),
    serializable: msg.getSerializable(),
    keysOnly: msg.getKeysOnly(),
...
proto.etcdserverpb.RangeRequest.prototype.getSortOrder = function() {
  return /** @type {!proto.etcdserverpb.RangeRequest.SortOrder} */ (jspb.Message.getFieldProto3(this, 5, 0));
};


/** @param {!proto.etcdserverpb.RangeRequest.SortOrder} value  */
...
proto.etcdserverpb.RangeRequest.prototype.getSortTarget = function() {
  return /** @type {!proto.etcdserverpb.RangeRequest.SortTarget} */ (jspb.Message.getFieldProto3(this, 6, 0));
};


/** @param {!proto.etcdserverpb.RangeRequest.SortTarget} value  */
...
proto.etcdserverpb.Compare.prototype.getResult = function() {
  return /** @type {!proto.etcdserverpb.Compare.CompareResult} */ (jspb.Message.getFieldProto3(this, 1, 0));
};


/** @param {!proto.etcdserverpb.Compare.CompareResult} value  */
...
proto.etcdserverpb.Compare.prototype.getTarget = function() {
  return /** @type {!proto.etcdserverpb.Compare.CompareTarget} */ (jspb.Message.getFieldProto3(this, 2, 0));
};


/** @param {!proto.etcdserverpb.Compare.CompareTarget} value  */
...
proto.etcdserverpb.SnapshotResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    header: (f = msg.getHeader()) && proto.etcdserverpb.ResponseHeader.toObject(includeInstance, f),
    remainingBytes: msg.getRemainingBytes(),
    blob: msg.getBlob()
  };
...
proto.etcdserverpb.WatchCreateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    key: msg.getKey(),
    rangeEnd: msg.getRangeEnd(),
    startRevision: msg.getStartRevision(),
    progressNotify: msg.getProgressNotify(),
...
proto.etcdserverpb.WatchCreateRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = /** @type {!Array.<!proto.etcdserverpb.WatchCreateRequest.FilterType>} */ (reader.readPackedEnum());
      msg.setFiltersList(value);
      break;
    case 6:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setPrevKv(value);
...
/** @param {!Array.<!proto.etcdserverpb.WatchCreateRequest.FilterType>} value  */
...
proto.etcdserverpb.WatchResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    canceled: msg.getCanceled(),
    compactRevision: msg.getCompactRevision(),
...
proto.etcdserverpb.AlarmRequest.prototype.getAction = function() {
  return /** @type {!proto.etcdserverpb.AlarmRequest.AlarmAction} */ (jspb.Message.getFieldProto3(this, 1, 0));
};


/** @param {!proto.etcdserverpb.AlarmRequest.AlarmAction} value  */
...
proto.etcdserverpb.AlarmRequest.prototype.getAlarm = function() {
  return /** @type {!proto.etcdserverpb.AlarmType} */ (jspb.Message.getFieldProto3(this, 3, 0));
};


/** @param {!proto.etcdserverpb.AlarmType} value  */
...
proto.etcdserverpb.AlarmMember.prototype.getAlarm = function() {
  return /** @type {!proto.etcdserverpb.AlarmType} */ (jspb.Message.getFieldProto3(this, 2, 0));
};
...
proto.etcdserverpb.StatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    dbsize: msg.getDbsize(),
    leader: msg.getLeader(),
    raftindex: msg.getRaftindex(),
    raftterm: msg.getRaftterm()
  };
